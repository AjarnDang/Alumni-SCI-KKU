...
<div class="row">
  ...
  <div class="card my-4">
    ...
    <?php 
    $comment=mysqli_query($conn,"SELECT tblcomments.id          as comment_id,
                                        tblcomments.postId      as postId,
                                        tblcomments.user_id     as user_id,
                                        tblcomments.name        as name,
                                        tblcomments.email       as email,
                                        tblcomments.comment     as comment,
                                        tblcomments.postingDate as postingDate,
                                        tblcomments.status      as status,
                                        user.id                 as id
                                  from tblcomments
                                  join user on user.id = tblcomments.user_id 
                                  where postId='$id' 
                                    and tblcomments.status = 1
                                ");
                  ...
                  <div class="modal fade" id="exampleModalCenter<?php echo $row['comment_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle<?php echo ($row['comment_id']);?>" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                              ...
                              <form method="POST" action="news_ac_editdelete_comment.php" enctype="multipart/form-data">  
                                <div class="modal-body">                                 
                                    <?php
                                    $edit=mysqli_query($conn,"SELECT * from tblcomments 
                      ...
                      <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                              ...
                              <form method="POST" action="news_ac_editdelete_comment.php" enctype="multipart/form-data">  
                                <div class="modal-body">                                 
                                    <?php
                                    $delete=mysqli_query($conn,"SELECT * from tblcomments 
                                                              where id='".$row['comment_id']."'");
