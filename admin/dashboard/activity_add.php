    ...
    // adding post  
     if(isset($_POST['submit'])) {
        ...
        if(!in_array($extension,$allowed_extensions)) {
            ...
            $status=1;
            $query=mysqli_query($conn,"INSERT into events(PostTitle,
                                                          CategoryId,
                                                          SubCategoryId,
                                                          PostDetails,
                                                          PostUrl,
            ...
            <div class="col-md-10 col-md-offset-1">
                ...
                <form name="addpost" method="post" enctype="multipart/form-data">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="posttitle" name="posttitle" placeholder="กรอกชื่อกิจกรรม" required>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 form-group mb-3">
                            <label for="exampleInputEmail1">เวลาเริ่มต้น</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 form-group mb-3">
                            <label for="exampleInputEmail1">เวลาสิ้นสุด</label>
                    ...
                    <div class="form-group">
                        <label for="header-title">เนื้อหากิจกรรม</label>
                        <textarea class="summernote" rows="5" name="postdescription" required></textarea>
                    </div>
    
                    <div class="form-group mt-2">
                        <label for="header-title">ภาพปกกิจกรรม</label>
                ...
                <div class="my-4">                 
                    ...
                    <a href="activity_add.php" class="btn btn-danger waves-effect waves-light">
                        ยกเลิก
                    </a>
                </div>                      
                </form>
