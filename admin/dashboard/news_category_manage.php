...
<body>
    <div class="container-fluid">
        <div class="bread-crump pt-2">
            ...
            <a href="#">ข่าวสาร</a> >
            <a href=" ">จัดการหมวดหมู่ข่าวสาร</a> 
        </div>
        <div class="pt-2 header-product">
		    <strong>จัดการหมวดหมู่ข่าวสาร</strong>
	    </div>
        <hr/> 
                ...
                <div class="table-responsive">
                    ...
                    <?php } else { 
                        ...
                        <tr>
                            ...
                            <td><?php echo date("$newDate")." ".$month_arr[date("$newMonth")]." ".(date("$newYear")+543);?></td>
                            <td><?php echo $updation_date; ?></td>
                            <td><a href="news_category_manage.php?resid=<?php echo htmlentities($row['id']);?>"><i class="fa fa-reply"></i></a> &nbsp;
                                <a href="news_category_manage.php?rid=<?php echo htmlentities($row['id']);?>&&action=parmdel" title="Delete forever"><i class="fa fa-trash-o" style="color: #f05050"></i></a>
                            </td>
                        </tr>
