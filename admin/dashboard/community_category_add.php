...
if(strlen($_SESSION['username'])=='admin') { 
    ...
    if($_GET['action']=='del' && $_GET['rid']) {
        $id=intval($_GET['rid']);
        $query=mysqli_query($conn,"UPDATE community_category set Is_Active='0' where id='$id'");
    ...
    if(isset($_POST['submit'])) {
        ...
        $status=1;
        $query=mysqli_query($conn,"INSERT into community_category
                                              (CategoryName,
                                               Description,
                                               Is_Active
                                               )
...
<body>
    <div class="container-fluid">
        <div class="bread-crump pt-2">
            ...
            <a href="#">คอมมูนิตี้</a> >
            <a href=" ">เพิ่มหมวดหมู่คอมมูนิตี้</a> 
        </div>
        <div class="pt-2 header-product">
		    <strong>เพิ่มหมวดหมู่คอมมูนิตี้</strong>
	    </div>
        <hr />
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <?php if($msg) { ?>
                    <div class="alert alert-success" role="alert">
                        <strong>เพิ่มหมวดหมู่สำเร็จ!</strong> <?php echo htmlentities($msg);?>
                    </div>
                <?php } ?>
                ...
                <?php if($error) { ?>
                    <div class="alert alert-danger" role="alert">
                        <strong>ขออภัย เกิดข้อผิดพลาดบางอย่าง!</strong> <?php echo htmlentities($error);?>
                    </div>
                <?php } ?>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="card">
                    ...
                    <form class="form-horizontal" name="category" method="post">
                        ...
                        <div class="form-group">
                        <button type="submit" class="btn btn-success" name="submit">เพิ่มข้อมูล</button>
                        </div>                   
                    </form>
                    </div>
                </div>
