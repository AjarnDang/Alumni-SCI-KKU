...
if(strlen($_SESSION['username'])=='admin') { 
    ...
    if(isset($_POST['submit'])) {
        ...
        $query=mysqli_query($conn,"UPDATE tblcategory
...
<body>
    <div class="container-fluid">
        <div class="bread-crump pt-2">
            ...
            <a href="#">ข่าวสาร</a> >
            <a href=" ">แก้ใขหมวดหมู่ข่าวสาร</a> 
        </div>
        <div class="pt-2 header-product">
		    <strong>แก้ใขหมวดหมู่ข่าวสาร</strong>
	    </div>
        <hr/> 
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group"><button type="submit" class="btn btn-success" name="submit">อัปเดต</button></div>
                            </form>
                        </div>
                    </div>                   
                </div>
