				...
				if(isset($_SESSION["cart_session"])) { 	
					...
					foreach ($_SESSION["cart_session"] as $cart_itm) {
						...
						$total = ($total + $subtotal); } ?>
							...
							<div class="icon-badge-group"><a class="social-md" href="login-system/login_form.php">
...
<div class="container">
	<a class="navbar-brand" href="home.php"><img src="assets/img/sci_logo.png" alt="sci-logo"></a>
	...
	<div class="collapse navbar-collapse" id="main_nav">
		<ul class="navbar-nav">
			<li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle
					...
					<?= ($activePage == 'donate_money') ? 'active' : ''; ?>
			...
			<li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle 
					...
					" data-bs-toggle="dropdown" href="#">ศิษย์เก่า</a>
			...
			<li class="nav-item dropdown">
			    ...
			    <ul class="dropdown-menu dropdown-menu-end">
				  ...
				  <li><a class="dropdown-item" href="#">วิดีทัศน์</a></li>
			    </ul>
			</li>
			<li class="nav-item">
				<a class="nav-link 
		...
		<ul class="navbar-nav ms-auto">
			<li class="nav-item dropdown">
				<a class="btn" onclick="window.location.href='login-system/login_form.php';">เข้าสู่ระบบ</a>
			</li>
		</ul>
	</div> <!-- navbar-collapse.// -->
</div> <!-- container-fluid.// -->
